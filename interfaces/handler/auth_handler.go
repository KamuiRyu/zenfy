...
func NewAuthHandler(u *usecase.LoginUseCase, v *usecase.VerifyEmailUseCase, r *usecase.ResendVerificationUseCase, pr *usecase.RequestPasswordResetUseCase, rp *usecase.ResetPasswordUseCase) *AuthHandler {
	return &AuthHandler{uc: u, verifyUC: v, resendUC: r, requestPasswordResetUC: pr, resetPasswordUC: rp}
}
